...
mixin _$UserSingleResponse {
  ...
  /// Serializes this UserSingleResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UserSingleResponse
...
abstract class $UserSingleResponseCopyWith<$Res> {
  factory $UserSingleResponseCopyWith(
    UserSingleResponse value,
    $Res Function(UserSingleResponse) then,
...
abstract class _$$UserSingleResponseImplCopyWith<$Res>
    implements $UserSingleResponseCopyWith<$Res> {
  factory _$$UserSingleResponseImplCopyWith(
    _$UserSingleResponseImpl value,
...
class __$$UserSingleResponseImplCopyWithImpl<$Res>
  ...
  __$$UserSingleResponseImplCopyWithImpl(
    _$UserSingleResponseImpl _value,
...
class _$UserSingleResponseImpl implements _UserSingleResponse {
  const _$UserSingleResponseImpl({required this.data});
  ...
  Map<String, dynamic> toJson() {
    return _$$UserSingleResponseImplToJson(this);
  }
}

abstract class _UserSingleResponse implements UserSingleResponse {
  const factory _UserSingleResponse({required final UserModel data}) =
      _$UserSingleResponseImpl;
